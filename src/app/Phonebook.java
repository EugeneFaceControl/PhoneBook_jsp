...
public class Phonebook {
	...
	public boolean addPerson(Person person)
	{
		ResultSet db_result;
		String query;
		int phonesSize = person.getPhones().size();
		String[] queryForPhone = new String[phonesSize];
		for (int i = 1; i <= person.getPhones().size(); i++) {
			queryForPhone[i] = "INSERT INTO 'phone' ('owner', 'number') VALUES ('" + person.getPhones().get(String.valueOf(i));
